...
export interface Plan { id: string; product: string; key: string; name: string; tagline: string | null; price_monthly: number | string; price_yearly: number | string | null; currency: string; features: string[]; limits: Record<string, number>; entitlements: Record<string, { enabled: boolean; quantity?: number | null; period?: 'day' | 'week' | 'month' | 'year' | null }>; highlight: boolean; is_visible: boolean; sort_order: number; updated_at: string }
